...
\begin{tcolorbox}
[colback=green!5,colframe=green!40!black,title=Exemplos deste capítulo:]
#1
\end{tcolorbox}
\end{wrapfigure}
}
...
%\input{09.OO} % Não vale a pena gastar tempo com isto.
\input{09.Send_receive}
%\input{11.clock}
\part{GUI}
\input{08.1.GUI}
\input{09.gui_plugins}
\input{08.gui}
\input{10.gui_propriedades}
%\part{Usando o PD para construir aplicações}
%\input{12.de_patch_para_c}
